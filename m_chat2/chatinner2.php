...
function DispData($mode,$sort,$word,$key,$page,$lid,$token)
{
	...
	$uid=$_GET['uid'];
	$StrSQL="SELECT *, NEWDATE as LKDATE, ID as CID FROM DAT_MESSAGE where AID='".$word."' and ETC02='".$_GET['etc02']."' and ifnull(ETC03,'')='".$_GET['etc03']."' and ENABLE='ENABLE:公開中' order by DAT_MESSAGE.ID desc LIMIT 0, 1;";
