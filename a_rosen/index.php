...
//	$StrSQL="SELECT PREFCD, N3, count(ID) as CNT FROM DAT_ROSEN group by PREFCD, N3 order by PREFCD, N3";
//	$rs=mysqli_query(ConnDB(),$StrSQL);
//	while ($item = mysqli_fetch_assoc($rs)) {
//		if($item['CNT']>1){
//			$StrSQL="SELECT CD3 FROM DAT_ROSEN where PREFCD='".$item['PREFCD']."' and N3='".$item['N3']."' order by CD3 limit 0, 1";
//			$rs2=mysqli_query(ConnDB(),$StrSQL);
//			$item2 = mysqli_fetch_assoc($rs2);
//			$StrSQL="UPDATE DAT_ROSEN SET CD4='".$item2['CD3']."' where PREFCD='".$item['PREFCD']."' and N3='".$item['N3']."'";
...
//各テンプレートファイル名
  $htmlnew = "./a_rosen_edit.html";
  $htmledit = "./a_rosen_edit.html";
  $htmlconf = "./a_rosen_conf.html";
  $htmlend = "./a_rosen_end.html";
  $htmldisp = "./a_rosen_disp.html";
  $htmlerr = "./a_rosen_edit.html";
  $htmllist = "./a_rosen_list.html";
