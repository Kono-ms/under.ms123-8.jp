...
function DispData($mode,$sort,$word,$key,$page,$lid,$token,$sel1,$sel2)
{
	...
	print $str;
		...
		//$StrSQL="SELECT DAT_O2.* FROM DAT_O2 inner join DAT_M2 on DAT_M2.MID=DAT_O2.MID and DAT_M2.ENABLE = 'ENABLE:公開中' and DAT_O2.ENABLE = 'ENABLE:公開中' and ".ListSQLSearch($sort,$word,$sel1,$sel2);
		$StrSQL="SELECT DAT_O2.ID,DAT_O2.MID,DAT_O2.OID FROM DAT_O2 inner join DAT_M2 on DAT_M2.MID=DAT_O2.MID and DAT_M2.ENABLE = 'ENABLE:公開中' and DAT_O2.ENABLE = 'ENABLE:公開中' and ".ListSQLSearch($sort,$word,$sel1,$sel2);
		$rs=mysqli_query(ConnDB(),$StrSQL);
