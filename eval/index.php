...
function Main()
{
	...
	if($mode == 'new') {
		...
		$mode = "eval_error";
			...
			$StrSQL="SELECT ID FROM DAT_MCONTACT where ID='".$_GET['contact_id']."' and ((MID='".$_GET['mid1']."' and  MIDT='".$_GET['mid2']."') or (MID='".$_GET['mid2']."' and  MIDT='".$_GET['mid1']."')) and STATUS='STATUS:".LAST_STATUS."';";
